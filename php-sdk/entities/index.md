...
Por ejemplo, cuando obtienes un producto con `$client->products()->get()`, obtienes como resultado un objeto (entidad) de la clase [!badge variant="info" text="Product"](/php-sdk/entities/product) que incluye, entre otras cosas el identificador internto del producto en Biteral y el estado del procesamiento.
