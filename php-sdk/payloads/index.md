...
Por ejemplo, cuando [añades un producto a Biteral](/php-sdk/products) con `$client->products()->post()`, debes proporcionar como parámetro un objeto de la clase [!badge variant="info" text="ProductPayload"](/php-sdk/payloads/product-payload)
