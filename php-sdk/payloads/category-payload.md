...
[!badge icon="screen-full" text="name"]|string|Nombre de la categoría, por ejemplo: `Zapatillas deportivas`
[!badge icon="screen-full" text="name"]|description|Descripción del tipo de productos que contiene la categoría, por ejemplo: `Calzado diseñado para actividades físicas y deportivas. Incluye zapatillas para correr, entrenar, practicar deportes específicos o vestir con estilo deportivo en el día a día.`
