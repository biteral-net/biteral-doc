---
label: EventRemovedFromCartPayload
expanded: false
icon: arrow-right
order: 990
---
...
[!badge icon="screen-full" text="quantity"]|int|La cantidad de unidades de este producto retiradas del carrito. Si no se especifica, el valor por defecto es `1`
