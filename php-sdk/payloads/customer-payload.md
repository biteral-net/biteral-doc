...
[!badge icon="screen-full" text="country"]|string|País donde el cliente se ubica, un código [ISO 3166-1 alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) como por ejemplo `ESP`
[!badge icon="screen-full" text="state"]|string|Estado, región, comunidad o provincia donde el cliente se ubica, un código [ISO 3166-2](https://en.wikipedia.org/wiki/ISO_3166-2) como por ejemplo `ES-B`
[!badge icon="screen-full" text="city"]|string|Ciudad donde el cliente se ubica, un [WikiData ID](https://www.wikidata.org/wiki/Wikidata:Identifiers) como por ejemplo `Q11355`
