...
[!badge icon="screen-full" text="city"]|string|Ciudad donde el cliente se ubica, un [WikiData ID](https://www.wikidata.org/wiki/Wikidata:Identifiers) (por ejemplo, `Q11355`). Cuando se envían datos, también acepta el nombre de la ciudad en inglés o en lengua nativa (por ejemplo, `Antwerp`)
